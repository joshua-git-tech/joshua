            ...
            <div className="row">
              <div className="col col-6 border-line-v">
                <div className="text-box" data-aos="fade-up">
                  <p>
                    Experienced Full-Stack Developer with a strong foundation in both frontend and backend technologies, including Angular,
                    React.js, and Node.js. Skilled in building robust and scalable applications in .NET and C#, with a proven track record of
                    delivering efficient and user-centric solutions. Known for a versatile approach to problem-solving, and adept at
                    collaborating across teams to achieve project goals. Passionate about leveraging cutting-edge technologies to drive
                    innovation and improve performance in web applications.
                  </p>
                </div>
              </div>
              <div className="col col-6 border-line-v">
                <div className="info-list" data-aos="fade-up">
                  <ul>
                    ...
                    <li>
                      <strong>Birthday: </strong>15 January 1991
                    </li>
                    <li>
                      <strong>Gmail: </strong>joshua.jimenez.negron@gmail.com
                    </li>
                    <li>
                      <strong>Residence: </strong>Texas City, TX
                    </li>
                  </ul>
                </div>
              </div>
